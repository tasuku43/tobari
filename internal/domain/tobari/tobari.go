...
const (
	...
	ServiceRequestKind            = "service-request"
	ServiceExposureKind           = "service-exposure"
	ServiceAttachmentKind         = "service-attachment"
	ServiceAttachmentServicesKind = "service-attachment-services"
