...
func TestStatusHomeSurfacesMutationRecoveryBeforeOrdinaryEntryGuidance(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "pending context entry", observation: FinalAuthorityMutationObservation{ActiveDecision: true, Operation: "context-entry", Target: contextRef, ProjectRoot: "/workspace/example", WorkspaceID: WorkspaceID("01912345-6789-7abc-8def-0123456789ae")}, wantPath: "tobari"},
