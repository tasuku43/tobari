				...
				Fields: []OutputField{
					...
					{Name: "decisions", Type: OutputFieldTypeArray, Description: "Ordered stored rules repeated in the confirmed receipt.", Items: &OutputField{
						Type: OutputFieldTypeObject, Description: "One freshly revalidated applied decision.", Fields: []OutputField{
							...
							{Name: "protocol", Type: OutputFieldTypeString, Description: "Effective policy protocol.", Enum: []string{tobari.PolicyProtocolHTTP, tobari.PolicyProtocolGraphQL, tobari.PolicyProtocolMCP, tobari.PolicyProtocolAWS, tobari.PolicyProtocolKubernetes, tobari.PolicyProtocolGit, tobari.PolicyProtocolOCI}},
							{Name: "state_change", Type: OutputFieldTypeString, Description: "Conservative protocol-derived state-change potential; review evidence, never independent authority.", Enum: []string{tobari.PolicyStateChangeNone, tobari.PolicyStateChangePossible, tobari.PolicyStateChangeInteractive, tobari.PolicyStateChangeUnknown}},
...
func policyRuleOutputFields() []OutputField {
	return []OutputField{
		...
		{Name: "protocol", Type: OutputFieldTypeString, Description: "Effective policy protocol.", Enum: []string{"http", "graphql", "mcp", "aws", "kubernetes", "git", "oci"}},
		{Name: "state_change", Type: OutputFieldTypeString, Description: "Conservative protocol-derived state-change potential; review evidence, never independent authority.", Enum: []string{"not_expected", "possible", "interactive", "unknown"}},
...
func policyDenyChangeOutput() CommandOutput {
	return CommandOutput{
		...
		Fields: []OutputField{
			...
			{Name: "protocol", Type: OutputFieldTypeString, Description: "Effective stored policy protocol."},
			{Name: "state_change", Type: OutputFieldTypeString, Description: "Conservative protocol-derived state-change potential; review evidence, never independent authority.", Enum: []string{"not_expected", "possible", "interactive", "unknown"}},
