...
func finalContextEnterErrors(path, recovery string) []CommandError {
	return append(finalAuthorityMutationErrors(path, recovery),
		classifiedCommandError(fault.KindUnavailable, "workspace_entry_attachment_unavailable", false, fault.PhaseAttachment, fault.ChangeConfirmed, "context show", "Read the confirmed desired, applied, and active authority before another explicit entry."),
		classifiedCommandError(fault.KindUnavailable, "workspace_entry_interrupted", false, fault.PhaseMutation, fault.ChangePartial, "context show", "Read the preserved last-successful entry and active recovery authority."),
		...
		classifiedCommandError(fault.KindRejected, "workspace_entry_policy_memory_inactive", false, fault.PhasePrecondition, fault.ChangeNone, "context show", "Read current and active Policy Memory authority before explicit policy reconciliation."),
		classifiedCommandError(fault.KindUnavailable, "workspace_entry_observation_unavailable", false, fault.PhaseObservation, fault.ChangeNotApplicable, "context show", "Read desired, applied, and active authority without reconciling it."),
		classifiedCommandError(fault.KindCanceled, "workspace_entry_canceled", false, fault.PhasePrecondition, fault.ChangeNone, "context show", "Read current authority before deciding whether to enter again."),
	)
}
