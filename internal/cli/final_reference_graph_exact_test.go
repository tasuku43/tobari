...
func TestADR0084WholeCatalogReferenceGraphIsExact(t *testing.T) {
	...
	wantProduced := []finalCatalogReferenceEdge{
		...
		{Program: ProgramName, Command: "template plan", Kind: tobari.WorkspaceReferenceKind, Endpoint: "contexts[].workspaces[].workspace_ref"},
		...
		{Program: ProgramName, Command: "context apply", Kind: tobari.WorkspaceReferenceKind, Endpoint: "workspace_refs[]"},
		{Program: ProgramName, Command: "context list", Kind: tobari.ContextReferenceKind, Endpoint: "items[].context_ref"},
		{Program: ProgramName, Command: "context list", Kind: tobari.WorkspaceReferenceKind, Endpoint: "items[].workspace_refs[]"},
		{Program: ProgramName, Command: "context show", Kind: tobari.ContextReferenceKind, Endpoint: "context_ref"},
		{Program: ProgramName, Command: "context show", Kind: tobari.WorkspaceReferenceKind, Endpoint: "workspace_refs[]"},
	...
	wantConsumed := []finalCatalogReferenceEdge{
		...
		{Program: ProgramName, Command: "context use", Kind: tobari.ContextReferenceKind, Endpoint: "--id"},
