...
func TestFinalAuthorityCRUDCatalogDeclaresApplicationFaultClassifications(t *testing.T) {
	tests := []struct {
		...
		{path: "template plan", code: "template_exists", kind: fault.KindRejected, phase: fault.PhasePrecondition, change: fault.ChangeNone},
		...
		{path: "template migration plan", code: "template_not_found", kind: fault.KindNotFound, phase: fault.PhaseObservation, change: fault.ChangeNotApplicable},
		...
		{path: "template apply", code: "template_not_found", kind: fault.KindNotFound, phase: fault.PhasePrecondition, change: fault.ChangeNone},
		...
		{path: "context apply", code: "template_not_found", kind: fault.KindNotFound, phase: fault.PhasePrecondition, change: fault.ChangeNone},
