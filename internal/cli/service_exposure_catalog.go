...
func serviceRequestFields() []OutputField {
	return []OutputField{
		...
		{Name: "context_id", Type: OutputFieldTypeString, Description: "Stable final Context authority identity."},
