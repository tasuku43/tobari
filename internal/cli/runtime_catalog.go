		...
		Agent: AgentContract{
			...
			Output: CommandOutput{
				...
				Fields: []OutputField{
					...
					{Name: "proxy", Type: OutputFieldTypeString, Description: "Tobari-internal explicit proxy endpoint, or null when unconfigured.", Nullable: true},
				...
				Delivery: OutputDeliveryComplete, CollectionCoverage: CollectionCoverageExhaustive,
				JSONEnvelope: "cluster", JSONEnvelopeType: OutputFieldTypeObject, JSONSchemaVersion: 5,
			},
			Prerequisites: []string{},
