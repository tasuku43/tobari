...
func runtimeCommandSpecs() []CommandSpec {
	...
	specs = append(specs,
		...
		finalTemplateMigrationPlanSpec(),
		finalTemplateMigrationApplySpec(),
	...
	return CommandSpec{
		...
		Agent: AgentContract{
			...
			Errors: mutationCommandErrors("runtime build", "review runtimes",
				...
				classifiedCommandError(fault.KindRejected, "runtime_lifecycle_active", false, fault.PhasePrecondition, fault.ChangeNone, "review runtimes", "Review and recover the exact retained Runtime lifecycle authority."),
				declaredCommandError(fault.KindInternal, "runtime_read_failed", false, "doctor", "Inspect the host Runtime store."),
				declaredCommandError(fault.KindContract, "invalid_runtime_list", false, "doctor", "Inspect the host Runtime store."),
				...
				classifiedCommandError(fault.KindUnavailable, "runtime_image_build_failed", false, fault.PhaseMutation, fault.ChangeUnknown, "doctor", "Inspect Docker build support and network access for pinned agent downloads."),
				declaredCommandError(fault.KindRejected, "runtime_recovery_observation_unknown", false, "review runtimes", "Retry the trusted-host read-only review."),
	...
	return CommandSpec{
		...
		Agent: AgentContract{
			...
			Output: CommandOutput{
				...
				JSONEnvelope: "denials", JSONEnvelopeType: OutputFieldTypeObject, JSONSchemaVersion: 5,
			},
	...
	return CommandSpec{
		...
		Agent: AgentContract{
			...
			Output: CommandOutput{
				...
				Delivery: OutputDeliveryComplete, CollectionCoverage: CollectionCoverageBoundedWindow,
				JSONEnvelope: "policy_candidates", JSONEnvelopeType: OutputFieldTypeObject, JSONSchemaVersion: 3,
			},
	...
	return CommandSpec{
		...
		Agent: AgentContract{
			...
			Output: CommandOutput{
				...
				Delivery: OutputDeliveryComplete, CollectionCoverage: CollectionCoverageExhaustive,
				JSONEnvelope: "policy_rules", JSONEnvelopeType: OutputFieldTypeObject, JSONSchemaVersion: 3,
			},
...
func policyRuleOutputFields() []OutputField {
	return []OutputField{
		...
		{Name: "aws_protocol_version", Type: OutputFieldTypeString, Description: "Exact AWS Query protocol version; empty outside AWS Query."},
		{Name: "aws_target_namespace", Type: OutputFieldTypeString, Description: "Exact AWS JSON target namespace; empty outside AWS JSON."},
		{Name: "aws_operation", Type: OutputFieldTypeString, Description: "Exact observed AWS wire operation token; empty outside AWS."},
		{Name: "kubernetes_kind", Type: OutputFieldTypeString, Description: "Exact Kubernetes resource or non-resource kind; empty outside Kubernetes."},
		{Name: "kubernetes_verb", Type: OutputFieldTypeString, Description: "Exact Kubernetes API verb; empty outside Kubernetes."},
		{Name: "kubernetes_group", Type: OutputFieldTypeString, Description: "Exact Kubernetes API group; empty denotes core or non-resource."},
		{Name: "kubernetes_version", Type: OutputFieldTypeString, Description: "Exact Kubernetes API version; empty outside resource requests."},
		{Name: "kubernetes_resource", Type: OutputFieldTypeString, Description: "Exact Kubernetes resource coordinate; empty outside resource requests."},
		{Name: "kubernetes_namespace", Type: OutputFieldTypeString, Description: "Exact Kubernetes namespace; empty when not applicable."},
		{Name: "kubernetes_name", Type: OutputFieldTypeString, Description: "Exact Kubernetes object name; empty when not applicable."},
		{Name: "kubernetes_subresource", Type: OutputFieldTypeString, Description: "Exact Kubernetes subresource; empty when not applicable."},
		{Name: "kubernetes_dry_run", Type: OutputFieldTypeString, Description: "Exact Kubernetes dry-run mode; empty outside Kubernetes."},
		{Name: "kubernetes_non_resource_path", Type: OutputFieldTypeString, Description: "Exact Kubernetes non-resource path; empty outside non-resource requests."},
...
func policyDenyChangeOutput() CommandOutput {
	return CommandOutput{
		...
		Fields: []OutputField{
			...
			{Name: "aws_protocol_version", Type: OutputFieldTypeString, Description: "Stored exact AWS Query protocol version; empty outside AWS Query."},
			{Name: "aws_target_namespace", Type: OutputFieldTypeString, Description: "Stored exact AWS JSON target namespace; empty outside AWS JSON."},
			{Name: "aws_operation", Type: OutputFieldTypeString, Description: "Stored exact AWS wire operation token; empty outside AWS."},
			{Name: "kubernetes_kind", Type: OutputFieldTypeString, Description: "Stored Kubernetes resource or non-resource kind; empty outside Kubernetes."},
			{Name: "kubernetes_verb", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes API verb; empty outside Kubernetes."},
			{Name: "kubernetes_group", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes API group; empty denotes core or non-resource."},
			{Name: "kubernetes_version", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes API version; empty outside resource requests."},
			{Name: "kubernetes_resource", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes resource coordinate; empty outside resource requests."},
			{Name: "kubernetes_namespace", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes namespace; empty when not applicable."},
			{Name: "kubernetes_name", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes object name; empty when not applicable."},
			{Name: "kubernetes_subresource", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes subresource; empty when not applicable."},
			...
			{Name: "kubernetes_non_resource_path", Type: OutputFieldTypeString, Description: "Stored exact Kubernetes non-resource path; empty outside non-resource requests."},
