			...
			Output: CommandOutput{
				...
				Fields: []OutputField{
					...
					{Name: "window_lines", Type: OutputFieldTypeInteger, Description: "Maximum recent Gateway lines inspected."},
					{
						...
						Description: "Validated denials ordered oldest to newest with scheme-independent request authority (host and port), method, path, reason, status, and exact-rule learnability.",
					},
