	...
	return CommandSpec{
		...
		Agent: AgentContract{
			...
			Errors: readCommandErrors("review runtimes", true,
				...
				classifiedCommandError(fault.KindNotFound, "runtime_revision_not_found", false, fault.PhasePrecondition, fault.ChangeNone, "runtime history", "Discover the current retained Runtime revisions."),
				classifiedCommandError(fault.KindRejected, "runtime_retirement_observation_unknown", false, fault.PhaseObservation, fault.ChangeNotApplicable, "doctor", "Inspect the host Runtime lifecycle state."),
				...
				classifiedCommandError(fault.KindRejected, "runtime_revision_unrestorable", false, fault.PhaseVerification, fault.ChangeConfirmed, "runtime history", "Review the retained immutable revision authority."),
				...
				classifiedCommandError(fault.KindInternal, "runtime_build_observation_unknown", false, fault.PhaseVerification, fault.ChangeConfirmed, "runtime show", "Reconcile the confirmed Runtime revision and current material availability."),
				classifiedCommandError(fault.KindContract, "invalid_runtime_report_confirmed", false, fault.PhaseVerification, fault.ChangeConfirmed, "runtime show", "Reconcile the confirmed Runtime revision and current material availability."),
	...
	return CommandSpec{
		...
		Agent: AgentContract{
			...
			Errors: mutationCommandErrors("runtime restore", "runtime history",
				classifiedCommandError(fault.KindInvalidInput, "invalid_runtime_revision_ref", false, fault.PhasePrecondition, fault.ChangeNone, "runtime history", "Use one managed Runtime revision reference unchanged."),
				classifiedCommandError(fault.KindNotFound, "runtime_not_found", false, fault.PhasePrecondition, fault.ChangeNone, "runtime list", "Discover the current managed Runtime catalog."),
				classifiedCommandError(fault.KindNotFound, "runtime_revision_not_found", false, fault.PhasePrecondition, fault.ChangeNone, "runtime history", "Discover the current retained Runtime revisions."),
				classifiedCommandError(fault.KindRejected, "runtime_retirement_observation_unknown", false, fault.PhaseObservation, fault.ChangeNotApplicable, "doctor", "Inspect the host Runtime lifecycle state."),
				classifiedCommandError(fault.KindRejected, "runtime_lifecycle_active", false, fault.PhasePrecondition, fault.ChangeNone, "review runtimes", "Review the retained Runtime lifecycle journal."),
				classifiedCommandError(fault.KindRejected, "runtime_revision_unrestorable", false, fault.PhaseVerification, fault.ChangeNone, "runtime history", "Review the retained immutable revision authority."),
				classifiedCommandError(fault.KindInternal, "runtime_restore_interrupted", false, fault.PhaseMutation, fault.ChangePartial, "review runtimes", "Resume the exact retained restore authority."),
				classifiedCommandError(fault.KindInternal, "runtime_restore_outcome_unknown", false, fault.PhaseMutation, fault.ChangeUnknown, "review runtimes", "Observe the retained Runtime lifecycle journal before another mutation."),
				classifiedCommandError(fault.KindContract, "invalid_runtime_restore_result_partial", false, fault.PhaseVerification, fault.ChangePartial, "runtime history", "Reconcile the retained Runtime revision and current image availability."),
				classifiedCommandError(fault.KindContract, "invalid_runtime_restore_result_confirmed", false, fault.PhaseVerification, fault.ChangeConfirmed, "runtime history", "Reconcile the retained Runtime revision and current image availability."),
