...
func generateVersions(root, sourceRef string, catalog catalogDocument) (componentVersionDocument, error) {
	...
	gatewayVersion := "release-generated V1"
	authBrokerVersion := "release-generated V1"
	gatewayIdentity := "injected immutable digest"
	authBrokerIdentity := "injected immutable digest"
	gatewayAuthority := "component-lock.json generated by the release workflow"
	authBrokerAuthority := "component-lock.json generated by the release workflow"
	// Historical documentation snapshots may predate ADR 0032. Preserve what
