...
export const learningPathPages = [
  ...
  page(
    ...
    "設定を分ける（Context）",
    "Learn Contexts only when you need different runtimes, authentication sets, or policy modes.",
    "ランタイム、認証、ポリシーを用途ごとに分ける必要が出た段階で Context を学びます。",
  ),
  page(
    10,
    ...
    "設定を分ける必要性を理解した後で、Context と Workspace、共有サービスの関係を確認します。",
  ),
  page(
    10,
