...
- A fresh synthetic project directory, no Workspace, no active Context recipe,
  and no pre-existing scenario-owned cluster state.
...
- Two fresh synthetic project directories under one temporary parent, no
  project Workspaces, and no scenario-owned cluster state.
...
- A fresh project and ready cluster, entered through a real pty.
...
- A fresh synthetic project directory and no scenario-owned cluster state.
